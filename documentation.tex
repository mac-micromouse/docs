...
\chapter{Hardware Theory} \label{ch:hardware_theory}
	...
	\noindent
	There are 25 GPIO pins avaiable for general use. GPIO 35-36 are input only pins that do not include internal
	...
	\noindent
	Finally, the ESP32 runs at 3.3V. It is has two power pins: VIN and 3V3. The VIN pin can accept external power 
	...
	condtions) and supports measurement rates up to 50Hz. Figure \ref{fig:vl53l1x-module} shows the module used.
